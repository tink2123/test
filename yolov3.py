...
class YOLOv3(object):
    ...
    def build_model(self):
        ...
        # blocks = mobile_net(self.image, 1.0, not self.is_train)
        blocks = add_ResNet_conv5_body(self.image,18)
        #var = np.array(fluid.global_scope().find_var('conv2d_0.w_0').get_tensor())
        #print(var)
