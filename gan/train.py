    ...
    def test(epoch):
        ...
        for data_A, data_B in zip(A_test_reader(), B_test_reader()):
            ...
            fake_A_temp, fake_B_temp, cyc_A_temp, cyc_B_temp = exe.run(
                gen_trainer.infer_program,
                fetch_list=[
                    gen_trainer.fake_A, gen_trainer.fake_B, gen_trainer.cyc_A,
                    gen_trainer.cyc_B
                ],
...
###            exe, out_path + "/g_b", main_program=g_B_trainer.program)
    ...
    def init_model():
        ...
        fluid.io.load_persistables(
            exe, args.init_model + "/gen", main_program=gen_trainer.program)
###        fluid.io.load_persistables(
...
###
            ...
            t_time += batch_time
            print(
                "epoch{}; batch{}; d_A_loss: {}; g_A_loss: {}; g_A_cyc_loss: {}; g_A_idt_loss: {}; d_B_loss: {}; g_B_loss: {}; g_B_cyc_loss: {}; g_B_idt_loss: {}; Batch_time_cost: {:.2f}".format(epoch, batch_id, d_A_loss[0], g_A_loss[0], g_A_cyc_loss[0], g_A_idt_loss[0], d_B_loss[0], g_B_loss[0], g_B_cyc_loss[0], g_B_idt_loss[0], batch_time))
            with open('logging_{}.txt'.format(args.changes), 'a') as log_file:
                now = time.strftime("%c")
                log_file.write(
                "time: {}     epoch{}; batch{}; d_A_loss: {}; g_A_loss: {}; g_A_cyc_loss: {}; g_A_idt_loss: {}; d_B_loss: {}; g_B_loss: {}; g_B_cyc_loss: {}; g_B_idt_loss: {}; Batch_time_cost: {:.2f}\n".format(now, epoch, batch_id, d_A_loss[0], g_A_loss[ 0], g_A_cyc_loss[0], g_A_idt_loss[0], d_B_loss[0], g_B_loss[0], g_B_cyc_loss[0], g_B_idt_loss[0], batch_time))
